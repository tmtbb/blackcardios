...
//        _showImageView.backgroundColor=[UIColor blueColor];
    ...
    _praiseBtn.frame=CGRectMake(10, _showImageView.frame.size.height+_showImageView.frame.origin.y+10, 23+_praiseLabel.frame.size.width, 30);
     _praiseBtn.imageEdgeInsets=UIEdgeInsetsMake(7, 0, 8, _praiseBtn.frame.size.width-15);
    
    
    //评论按钮
    _commentBtn.frame=CGRectMake(22+_praiseBtn.frame.size.width,_praiseBtn.frame.origin.y, 80, 30);
...
-(void)prepareForReuse{
    [_showImageView.subviews enumerateObjectsUsingBlock:^(__kindof UIView * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
