...
-(void)setupSubViews {
    ...
    for (int i = 0; i < RowPicCount; i ++) {
        ...
        selectIconIV.layer.shadowColor = [UIColor whiteColor].CGColor;
        selectIconIV.layer.shadowRadius = 4;
        selectIconIV.layer.shadowOpacity = 1;
        selectIconIV.layer.shadowOffset = CGSizeMake(5, 5);
        selectIconIV.layer.masksToBounds = YES;
        selectIconIV.layer.cornerRadius = selectIconIV.bounds.size.width / 2.0;
